  @component('admin.layouts.content', [
      'title' => 'اختصاص کاربر به فرم',
      'tabTitle' => 'اختصاص کاربر به فرم',
      'breadcrumb' => [['title' => 'لیست فرمهای کاربران', 'url' => route('admin.form.form_category.index')], ['title' => 'اختصاص کاربر به فرم',
      'class' => 'active']],
      ])
